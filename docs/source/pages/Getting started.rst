...
* There are two ways to go about it:
    * Localhost: This just needs to be extracted
        ...
        * .. raw:: html
             ...
             <a href="https://github.com/kanors-emr/Veda2.0-Installation/releases/download/v3.0.7.0/Veda2.0_localhost_3.0.7.0.7z" target="blank">Download localhost</a>
    ...
    * Installer: This is a setup executable
        * .. raw:: html
            ...
            <a href="https://github.com/kanors-emr/Veda2.0-Installation/releases/download/v3.0.7.0/Veda2.0.Setup.3.0.7.0.exe" target="blank">Download installer</a>
