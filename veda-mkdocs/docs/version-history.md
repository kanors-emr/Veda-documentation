...
- Fixed issue regarding the ~TFM_FILL-R processing: Regular vs.
    Parametric Scenarios [See Details](https://forum.kanors-emr.org/showthread.php?tid=1606){ target="_blank" rel="noopener noreferrer" }
...
- Added option to export run status to Excel with improved progress
    grid visualization in Run Manager. [See Details](https://forum.kanors-emr.org/showthread.php?tid=1601){ target="_blank" rel="noopener noreferrer" }

- Enable RFCmd* and SFCmd* commands for parametric scenario. [See Details](https://forum.kanors-emr.org/showthread.php?tid=1603&pid=8652#pid8652){ target="_blank" rel="noopener noreferrer" }
...
- Fixed issue preventing changes to uncertainty in Properties groups
    with in the Run Manager. [See Details](https://forum.kanors-emr.org/showthread.php?tid=1600){ target="_blank" rel="noopener noreferrer" }
...
- If climate and base entries, such as TOTCH4 and TOTN2O, are also
    ...
    exclusion rules in SNT processing. [See Details](https://forum.kanors-emr.org/showthread.php?tid=1591&pid=8544#pid8544){ target="_blank" rel="noopener noreferrer" }
- Fixed commodity definitions inconsistencies due to missing sector in
    uniqueness checks. [See Details](https://forum.kanors-emr.org/showthread.php?tid=1589&pid=8523#pid8523){ target="_blank" rel="noopener noreferrer" }
...
- Improved the SnT processing to ensure reserved commodities are
    ...
    accuracy. [See details](https://forum.kanors-emr.org/showthread.php?tid=1540){ target="_blank" rel="noopener noreferrer" }
- Commodity Group QC for FLO* and VDA_FLOP attributes. The core
    ...
    mistakenly. [See details](https://forum.kanors-emr.org/showthread.php?tid=1540&pid=8256#pid8256){ target="_blank" rel="noopener noreferrer" }
...
- Improved UC Tags Handling in SubParametric Scenarios. Resolved an
    ...
    in the dimension_elements table, enhancing the reliability of
    scenario processing.
...
- Introduces a new process IMPDUCZ to supply the dummy commodities
    used to relax User Constraints. [See details](https://forum.kanors-emr.org/showthread.php?tid=1213&pid=8049#pid8049){ target="_blank" rel="noopener noreferrer" }
- New ~FI_PROCESS_Trades tag supported in the Trade links file for
...
- Controlled Splitting of Other_Indexes [See details](https://forum.kanors-emr.org/showthread.php?tid=1367&pid=8043#pid8043){ target="_blank" rel="noopener noreferrer" }
...
- **Reporting enhancements**
    ...
    - Includes multiplication support, parent region mapping, and
      improved unit conversion to TS_Ratios.
...
!!! note "Note"
    ...
    ([download](https://github.com/kanors-emr/Veda2.0-Installation/releases/tag/v3.2.1.0){ target="_blank" rel="noopener noreferrer" }).
...
- Can't create new or view existing Table Master groups or select
    tables by filtering
    [#44](https://github.com/kanors-emr/Veda2.0-Installation/issues/44){ target="_blank" rel="noopener noreferrer" }
- Expanded Excel export limit in Items List
    [#43](https://github.com/kanors-emr/Veda2.0-Installation/issues/43){ target="_blank" rel="noopener noreferrer" }
- Enabled Excel export in Times and Veda Attributes
    [#43](https://github.com/kanors-emr/Veda2.0-Installation/issues/43#issuecomment-2269648594){ target="_blank" rel="noopener noreferrer" }
- Shorter list of VDA_FLOP Deletions
    [#42](https://github.com/kanors-emr/Veda2.0-Installation/issues/42#issuecomment-2452224383){ target="_blank" rel="noopener noreferrer" }
- Issue with UC on cum subsidies for period of years [See details](https://forum.kanors-emr.org/showthread.php?tid=1431&pid=7644#pid7644){ target="_blank" rel="noopener noreferrer" }
- Controversial handling of CG indexes by VEDA (FI_T) [See details](https://forum.kanors-emr.org/showthread.php?tid=1426&pid=7648#pid7648){ target="_blank" rel="noopener noreferrer" }
- Priority resolution of dimensions for tag processing [See details](https://forum.kanors-emr.org/showthread.php?tid=1426&pid=7598#pid7598){ target="_blank" rel="noopener noreferrer" }
- CG declarations in col headers [See details](https://forum.kanors-emr.org/showthread.php?tid=1426&pid=7614#pid7614){ target="_blank" rel="noopener noreferrer" }
...
- Removed more spurious sync log entries from FI_T tag
  processing.
...
- **Major Enhancement**: New feature on right click on any
  ...
  `Copy Veda-tag to clipboard`
  option.
- New tag ~NOPCOL (No operation column headers) supported in
  SysSettings [See details](https://forum.kanors-emr.org/showthread.php?tid=1364&pid=7484){ target="_blank" rel="noopener noreferrer" }
...
- Enhanced GDX file reference on Run Manager [See details](run-manager.md#managing-gdx-files)
- Input validation - non-numeric values. [User request](https://github.com/kanors-emr/Veda2.0-Installation/issues/35){ target="_blank" rel="noopener noreferrer" }
- Sync log warning if a single row uses seed values from
  multiple scenarios. [See details](https://forum.kanors-emr.org/showthread.php?tid=1377&pid=7380#pid7380){ target="_blank" rel="noopener noreferrer" }
- Sync logs in a text file. [User request](https://github.com/kanors-emr/Veda2.0-Installation/issues/39){ target="_blank" rel="noopener noreferrer" }
- New user option to not write Fill-R tables if the contents
  have not changed. Turned on by default. [User request](https://github.com/kanors-emr/Veda2.0-Installation/issues/37){ target="_blank" rel="noopener noreferrer" }

**[Fixes]**

- TFM_Fill-R tag writing during Sync was starting from cell
...
- SolveTime reporting (GAMS version 32 or higher is required
  as a minimum). [See details](https://github.com/kanors-emr/Veda2.0-Installation/issues/33){ target="_blank" rel="noopener noreferrer" }
- Remove filter option from check all tables in result
  viewer. [See details](https://github.com/kanors-emr/Veda2.0-Installation/issues/40){ target="_blank" rel="noopener noreferrer" }
...
- IRE_XBND parameter handle [See details](https://forum.kanors-emr.org/showthread.php?tid=1348&pid=7171){ target="_blank" rel="noopener noreferrer" }
- Enhanced QC of non-FI_T tags and DINS tags.
- HiGHS solver made available on Run Manager.
- TOP_IRE entries for trade processes coming from BY/SubRES
  [#28](https://github.com/kanors-emr/Veda2.0-Installation/issues/28){ target="_blank" rel="noopener noreferrer" }
- Enhanced GDX file reference on Run Manager

**[Fixes]**

- Units Conversion in Update Excel
- A bug was introduced in version 3.0.3 with FI_T tag QC. DINS
...
- Blank spaces after the Minus sign are removed in exclusion
  rules.
- Solving a case with multiple time slice definitions selected. [See details](https://github.com/kanors-emr/Veda2.0-Installation/issues/29){ target="_blank" rel="noopener noreferrer" }
- Super region is now case insensitive.
- Veda assigns dimension based on the element in FI_T/UC_T col
  headers and table tags. The allocation will be done in the
  following priority order:
  attribute,currency,lim_type,region,side,time_slice,year,commodity.

**[New]**

- Veda version introduced in the title of LST files.
- Attrib_cond/Val_cond feature was purely a process filter so
...
- **ALL VERSIONS**
    ...
    - `ACT` and `NRG` will be recognized as
    ...
    - Single-user view has been restored in Groups and Cases for
        ...
        recently but it was causing [some confusion](https://github.com/kanors-emr/Veda2.0-Installation/issues/23){ target="_blank" rel="noopener noreferrer" }.
...
!!! note "Note"
    ...
    ([download](https://github.com/kanors-emr/Veda2.0-Installation/releases/tag/v2.20.2.1){ target="_blank" rel="noopener noreferrer" }).
...
- Single-user view has been restored in Groups and Cases for Academic
    ...
    it was causing [some confusion](https://github.com/kanors-emr/Veda2.0-Installation/issues/23){ target="_blank" rel="noopener noreferrer" }.
...
- **ALL VERSIONS**
    ...
    - **Major Enhancement**: Excel file reading and writing are now
        ...
        [ASPOSE](https://products.aspose.com/cells/){ target="_blank" rel="noopener noreferrer" }. This makes the
    ...
    - Duplicate column headers will be identified even if the
        duplication is on account of aliases. [See details](https://github.com/kanors-emr/Veda2.0-Installation/issues/11){ target="_blank" rel="noopener noreferrer" }
    - A warning will be issued if there are unsaved modifications in
        groups in the Run Manager. [See details](https://github.com/kanors-emr/Veda2.0-Installation/issues/17){ target="_blank" rel="noopener noreferrer" }
...
- RES view in Item Details was missing some IRE process - UC
  links. [See details](https://github.com/kanors-emr/Veda2.0-Installation/issues/20){ target="_blank" rel="noopener noreferrer" }
- Topology tags (TFM_TOPINS*) tags were not being
...
- Topology tags were not being read from SysSettings. See
  ...
  supported.
- Removed spurious TOP_IRE entries. [See details](https://forum.kanors-emr.org/showthread.php?tid=1310){ target="_blank" rel="noopener noreferrer" }
...
- CmdF_Top attribute introduced to inject code before the GAMS call
    in VTRUN.CMD file.
...
- Variables $case_name and $vd_file_name introduced in the
...
- **[Debug] Default PCG allocation was wrong for some processes
  ...
  single-commodity CG. Here is the streamlined logic:**
    ...
    - PRC_PCG declaration via SysSettings has the highest
      priority.
    - PCG declaration via the primary_cg col of ~FI_Process
...
- **[Debug] Enabling the CMD file edit parameters: CmdF_GAMS,
  CmdF_Title, and CmdF_bot.**
...
- Information - Model - NSV Candidates: No-seed-value scenarios can
    be converted to Scen_NSV* directly via the UI
...
- **Retaining VD files is optional now.**
    [Details](run-manager.md#managing-output-files)
    .
...
- **Layout master functionality in pivot grids. See the new button
    ...
    in Reports**
- Some topology defaults have been changed to Input in the FI_T
...
- Deleted items view improved and moved to Information - Model menu
    (from Tools)
- A group named `all_<Parametric scenario name>` is created
...
- The following indexes are written in DD files without quotation
    marks: group, import_export, in_out, lim_type, name, parent,
    peak_time_slice, side, sow, stage, time_slice,
    time_slice_level, time_slice2, year, year2
...
- Parametric scenario group `<Parscen name>_all` is created
    automatically
- Topology check can be disabled in UC_T with "No" in top_check
    column
...
- QA_Check log file will open automatically after the run if it
...
- When Restart Option is active in Run Manager, Region and period
    selections are dumped in a file `<casename>_input_data.JSON`.

**ADVANCED VERSION**

- Reporting: WAttribute col in TS_Defs table can be used to
  compute dynamic weighted averages. See example in [Veda Adv
  Demo](https://github.com/kanors-emr/Model_Demo_Adv_Veda.git){ target="_blank" rel="noopener noreferrer" }.
...
- [Bugfix] User-defined sets were not available for processing if
    only BY_Trans was synchronized.
- Several UI enhancements.

**ADVANCED VERSION**

- Reporting: timeslice_map (like process_map and commodity_map)
...
- Process and commodity filters can be used in table tags. For
    example, ~TFM_INS: CSET_SET=DEM.
- TSLVL and SIDE forced to be upper case.
- UC_ATTR displayed under Items Detail of UC; also on mouseover
...
- Added support for the following TIMES attributes: ACT_FLO,
    CM_GHGMAP, NCAP_BPME, NCAP_CDME, NCAP_CEH, NCAP_CLAG,
    NCAP_ISPCT, RCAP_BLK
...
- Veda_SnT to Excel migration.xlsm handles possible duplication in
    Setrules table of Veda_SnT.MDB
...
- More tags, like FI_Process/Comm included in Information-Model
    tags.
...
- GAMS output had stopped appearing in CMD window for GAMS version
    32+.
- Handled the case where Sets col is blank in FI_Process/Comm
...
- Dummy commodities for UCs can be used in CSET_CN col of TFM
    tables.
