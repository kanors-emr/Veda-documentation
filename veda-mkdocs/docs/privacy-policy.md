...
>     downloaded by You on any electronic device, named Veda
>   - **Company** (referred to as either "the Company", "We", "Us" or
>     "Our" in this Agreement) refers to KanORS-EMR, SDF L7-B, NSEZ,
>     NOIDA 201305 INDIA.
...
!!! note "Note"
    ...
    If an organization obtains Veda license keys from KanORS-EMR, it must
    submit its own information including name, email, and address.
    Activation of license keys does not required employee details. Each
    activation associates the key with the computer or machine name and the
...
operating offices and on cloud servers used by the company. It will not
be transferred to any other party for processing.
