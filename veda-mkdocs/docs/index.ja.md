...
- **[インストールとセットアップ](getting-started.md)** — Veda のダウンロード、前提条件のインストール、最初のモデルの実行。
- **[概要](introduction.md)** — Veda の設計思想、アーキテクチャ、ライセンスの種類、ワークフロー。
- **[Veda タグ](tags/index.md)** — モデルのコンポーネントとパラメーターを宣言するための構文。
- **[レポート](reports.md)** — モデル出力の定義、分類、集計による下流分析と可視化。

## 多言語対応

このドキュメントは複数の言語で提供されています。右上の地球儀アイコンから、**English**、**日本語**、**Français**、**Deutsch**、**Español**、**中文** を切り替えられます。ナビゲーションのラベルは 6 言語すべてに翻訳されています。本文の翻訳は順次追加されており、未翻訳のページは英語版にフォールバックします。
