...
syntax, which started with the Flexible Import tag - **\~FI\_T** - in
...
Veda](https://veda-documentation.readthedocs.io/en/latest/pages/introduction.html#philosophy-and-core-principles).
...
**Logic Control Columns:**
  ...
  - **Within Name/Desc/Input/Output Block:**
      ...
      - `t_pos_andor`: Process positive conditions (AND/OR across
        pset\_pn, pset\_pd, pset\_ci, pset\_co)
...
2.  **Question Mark (`?`) or Underscore (`_`)** — single-character wildcard.
